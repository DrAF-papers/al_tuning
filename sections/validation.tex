...
\todo{Blurb about validation parameters, all the same as before execpt table below}
...
\todo{Blurb about being a wide parameter set and can be improved if tailoring is done to a specific parameter set.}