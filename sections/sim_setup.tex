...
\begin{table}[!htb]
	...
	\label{tab:nm_parameters}
		...
		\end{tabular}
\end{table}
These parameters were chosen because they fell within the guidelines from the algorithm description and after trial and error produced the most efficient \replaced{searching}{tuning} \cite{nelder_1965}.
...
\begin{table}[!htb]
	\centering
	\caption{\replaced{Generic Aluminum materials}{Material} properties found in the literature}
...
\begin{table}[!htb]
	\centering
	\caption{Experimental constants used in \replaced{search algorithm}{tuning} experiments}
