...
These experiments and simulations were the setup and analyzed as was used for the \replaced{search algorithm}{tuning} experimental setup.  The base experimental parameters can be seen in Table \ref{tab:exp_constants} with the scan speed and laser power being varied as seen in Table \ref{tab:val_parameters} and the simulation material properties were used from Table \ref{tab:7000_mat_prop_complete}.
\begin{table}[!htb]
	\centering
	\caption{\replaced{Laser processing parameters validation}{Validation} processing parameters}
...
\begin{figure}[!htb]\centering
	...
	\end{subfigure}\hfill{}
		...
		\end{subfigure}
	\caption{Comparison of experimental and simulated results for validation points with generic literature values for \added{aluminum} material dataset}
...
Additionally, run 1 was unable to develop a melt pool, which is contrary to the experiments where all the parameter sets had a stable melt track.  These results corroborate the results from Figure \ref{fig:response_complete} which showed that the parameter set used for \replaced{the search algorithm}{tuning} initial dataset of material properties found in the literature is wholly inadequate for simulating the process at hand. 
...
\begin{figure}[!htb]\centering
	...
	\end{subfigure}\hfill{}
		...
		\end{subfigure}
	\caption{Comparison of experimental and simulated results for \added{laser processing parameters} validation points with optimized values for \added{Aluminum} material dataset}
