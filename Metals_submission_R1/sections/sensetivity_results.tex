...
\begin{table}[!htb]
	...
	\label{tab:crit_mat_prop}
		...
		\end{tabular}
\end{table}
This work included the laser diameter in the search algorithms dataset due to the difficulty associated with accurately measuring the diameter\added{, this process is detailed in \cite{floodSensitivityAnalysisDirected2023}}.
